...
public final class CertificateData{
    ...
    private CertificateData(String chainData, String skinData) {
    ...
    public static CertificateData of(byte[] buffer) {
        ByteBuf byteBuf = Unpooled.wrappedBuffer(buffer);
        return new CertificateData(readString(byteBuf), readString(byteBuf));
    }

    public static CertificateData read(LoginPacket pk) {
        return new CertificateData(pk.getChainData().toString(), pk.getSkinData().toString());
    }
